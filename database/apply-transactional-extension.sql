-- AutaMedica Database Migration: Transactional Tables Extension
-- Migration Date: 2025-09-20
-- Author: Claude Code
-- Description: Add billing, payments, subscriptions, and audit logging tables

-- This migration can be safely run multiple times due to IF NOT EXISTS clauses
...
WHERE schemaname = 'public' 
  AND tablename IN (
    'billing_accounts', 'invoices', 'invoice_items', 'payments',
    'service_plans', 'subscriptions', 'audit_log', 'error_log'
  )
ORDER BY tablename;