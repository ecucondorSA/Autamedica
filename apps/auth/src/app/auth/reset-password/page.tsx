      ...
      <div className="w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg">
        <div className="rounded-lg sm:rounded-xl shadow-2xl p-4 sm:p-6 md:p-8 border relative" style={{backgroundColor: '#1a1a1a', borderColor: '#333333', backdropFilter: 'blur(10px)'}}>
          ...
          <div className="mt-4 sm:mt-6 pt-3 sm:pt-4 border-t border-gray-700/50 text-center relative">
            ...
            <a
              href="/auth/login"
              className="inline-flex items-center justify-center px-3 sm:px-4 py-1.5 sm:py-2 text-xs sm:text-sm font-medium text-gray-400 hover:text-gray-300 bg-gray-500/10 hover:bg-gray-500/20 border border-gray-500/20 rounded-lg transition-all duration-200 hover:scale-105"
            >
