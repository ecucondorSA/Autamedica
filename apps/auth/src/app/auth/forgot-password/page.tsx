        ...
        <div className="rounded-lg sm:rounded-xl shadow-2xl p-4 sm:p-6 md:p-8 border relative" style={{backgroundColor: '#1a1a1a', borderColor: '#333333', backdropFilter: 'blur(10px)'}}>
          ...
          <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-4">
            <div className="space-y-1 sm:space-y-2">
              <label htmlFor="email" className="flex items-center text-xs sm:text-sm md:text-base font-medium text-[var(--au-text-primary)]">
          ...
          <div className="mt-4 sm:mt-6 pt-3 sm:pt-4 border-t border-[var(--au-border)] text-center relative">
            ...
            <p className="text-xs sm:text-sm text-[var(--au-text-secondary)]">
              ¿Recordaste tu contraseña?
            </p>
            <a
              href="/auth/login"
              className="inline-flex items-center justify-center px-3 sm:px-4 py-1.5 sm:py-2 mt-2 text-xs sm:text-sm font-medium text-[var(--au-text-tertiary)] hover:text-[var(--au-text-secondary)] bg-[var(--au-accent)]/5 hover:bg-[var(--au-accent)]/10 border border-[var(--au-border)]/20 rounded-lg transition-all duration-200 hover:scale-105"
            >
