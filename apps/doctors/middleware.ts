/**
 * Middleware de autenticación para la aplicación de Doctors
...
export async function middleware(request: NextRequest) {
  ...
  try {
    ...
    // Solo permitir acceso a doctors y admins
    if (userRole !== 'doctor' && userRole !== 'admin' && userRole !== 'platform_admin') {
