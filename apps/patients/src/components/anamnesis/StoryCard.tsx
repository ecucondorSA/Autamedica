...
export function StoryCard({ intro, why, example, didYouKnow }: StoryCardProps) {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-2 mb-2">
      {/* Introducción */}
      <div className="card-ivory-elevated p-2 bg-gradient-to-br from-blue-50 to-white overflow-hidden">
      ...
      <div className="card-ivory p-2 border-l-4 border-emerald-500 overflow-hidden">
        <div className="flex items-start gap-2 min-w-0">
      ...
      {/* Ejemplo clínico */}
      {example && (
        <div className="card-ivory p-2 bg-amber-50 border border-amber-200 overflow-hidden">
          <div className="flex items-start gap-2 min-w-0">
      ...
      {/* ¿Sabías que? */}
      {didYouKnow && (
        <div className="card-ivory-elevated p-2 bg-gradient-to-br from-purple-50 to-white border-2 border-purple-300 overflow-hidden">
          <div className="flex items-start gap-2 min-w-0">
