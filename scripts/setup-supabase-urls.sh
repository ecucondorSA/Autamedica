...
echo ""
echo "Y agregar la URL de deployment de Cloudflare Pages (previews) cuando esté lista:"
echo "✅ https://autamedica-doctors.pages.dev/auth/callback"
echo ""
...
echo "   1. Ir a tu deployment de Cloudflare Pages"
