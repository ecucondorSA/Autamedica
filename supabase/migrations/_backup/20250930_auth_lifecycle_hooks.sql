...
BEGIN
  ...
  IF NOT EXISTS (
    ...
    CHECK (portal IN ('patients','doctors','companies','admin'))
    DEFAULT 'patients';
  END IF;
END $$;

-- Actualizar registros existentes que no tengan portal
UPDATE public.profiles
SET portal = CASE
  WHEN role = 'doctor' THEN 'doctors'
  WHEN role = 'company' THEN 'companies'
