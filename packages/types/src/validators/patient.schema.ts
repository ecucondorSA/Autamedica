 ...
 * - emergency_contact es JSONB con estructura {name, relationship, phone, email}
 * - address es JSONB con estructura {street, city, state, zipCode, country}
 * - date_of_birth (NO birth_date)
 *
 * ACTUALIZADO con TypeScript-aligned fields:
 * - first_name, last_name, email, phone (nuevos campos 2025-10-08)
 */
